package pv.selenium.adminConsole;
...
public class ProductSectionInsert extends BaseTest {


	@BeforeTest
	 public void init(){
	   xls = new Xls_Reader(Constants.adminConsole_XLS);
	   testName = "ProductSectionInsert";
	 }
	 
	 @Test(dataProvider="getData")
	 public void productSectionInsert(Hashtable<String,String> data){
	  test = rep.startTest(testName);
	  test.log(LogStatus.INFO, data.toString());
	  if(DataUtil.isSkip(xls, testName) || data.get("Runmode").equalsIgnoreCase("N")) {
