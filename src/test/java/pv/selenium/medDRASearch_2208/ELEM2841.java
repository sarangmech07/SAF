...
public class ELEM2841 extends BaseTest{
	/*Verify that when the user set the checkbox for the Non Current to True, 
	 * Non current LLT terms are included in search results
	 */
       @BeforeTest
       public void init(){
