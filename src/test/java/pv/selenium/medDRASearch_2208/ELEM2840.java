...
public class ELEM2840 extends BaseTest {
	/* Verify that when the user set the checkbox for the Full Search to False, 
	 * the search results includes terms which only starts with the search term.
	 * 
	 */
		@BeforeTest
	    public void init(){
