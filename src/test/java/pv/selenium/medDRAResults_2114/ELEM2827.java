...
public class ELEM2827 extends BaseTest {
	/*
	 * Verify that when the user has selected the level dropdown as 'LLT' , 
	 * the browser shows results only for the LLT level and synonym box is displayed if enabled at the organization
	 */
	@BeforeTest
    public void init(){
       xls = new Xls_Reader(Constants.ELEM_2114);
       testName = "ELEM2827";
