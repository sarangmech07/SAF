...
public class ELEM2826 extends BaseTest {
	/*Verify that when the user has selected the level dropdown as anything except 'All' and 'LLT' , 
	 * the browser shows results only for that level
	 */
	@BeforeTest
    public void init(){
