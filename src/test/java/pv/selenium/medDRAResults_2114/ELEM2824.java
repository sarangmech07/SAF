...
public class ELEM2824 extends BaseTest {
	@BeforeTest
    public void init(){
       xls = new Xls_Reader(Constants.ELEM_2114);
       testName = "ELEM2824";
       // Verify that when the user has selected the level dropdown as 'All' , 
       //the browser shows results at all levels(PT / LLT / SOC / HLGT / HLT) for the searched term without Synonym box
    }
