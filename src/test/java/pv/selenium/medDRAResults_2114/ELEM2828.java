...
public class ELEM2828 extends BaseTest {
	/*Verify that when the user enters an invalid search term which does not match the code in the dictionary or any error occurs,
